...
library LibClub250 {
    ...
    function buildClassicConfig() private {
        ...
        es.classicConfigurations[2] = LibClub250Storage.ClassicConfig(3, 2, 4000, 25 * 1e16, 40, 0, 2, 4000);
        es.classicConfigurations[3] = LibClub250Storage.ClassicConfig(6, 5, 9500, 28 * 1e16, 60, 0, 3, 9500);
        es.classicConfigurations[4] = LibClub250Storage.ClassicConfig(10, 9, 20000, 44 * 1e16, 80, 0, 4, 20000);
        es.classicConfigurations[5] = LibClub250Storage.ClassicConfig(15, 14, 45500, 66 * 1e16, 100, 0, 5, 45500);
        es.classicConfigurations[6] = LibClub250Storage.ClassicConfig(21, 20, 96000, 88 * 1e16, 120, 0, 6, 96000);
        es.classicConfigurations[7] = LibClub250Storage.ClassicConfig(28, 27, 196500, 10 * 1e17, 140, 0, 7, 196500);
        es.classicConfigurations[8] = LibClub250Storage.ClassicConfig(36, 35, 447000, 15 * 1e17, 160, 0, 8, 447000);
        es.classicConfigurations[9] = LibClub250Storage.ClassicConfig(45, 44, 947500, 20 * 1e17, 190, 0, 9, 947500);
        es.classicConfigurations[10] = LibClub250Storage.ClassicConfig(55, 54, 1948000, 30 * 1e17, 220, 0, 10, 1948000);
        es.classicConfigurations[11] = LibClub250Storage.ClassicConfig(66, 65, 3948500, 40 * 1e17, 250, 0, 11, 3948500);
        es.classicConfigurations[12] = LibClub250Storage.ClassicConfig(78, 77, 6949000, 50 * 1e17, 280, 0, 12, 6949000);
        es.classicConfigurations[13] = LibClub250Storage.ClassicConfig(91, 90, 10949500, 60 * 1e17, 330, 0, 13, 10949500);
        es.classicConfigurations[14] = LibClub250Storage.ClassicConfig(105, 104, 15950000, 70 * 1e17, 350, 0, 14, 15950000);
        es.classicConfigurations[15] = LibClub250Storage.ClassicConfig(120, 119, 21950500, 80 * 1e17, 370, 0, 15, 21950500);
        es.classicConfigurations[16] = LibClub250Storage.ClassicConfig(136, 135, 29451000, 90 * 1e17, 500, 0, 16, 29451000);
        es.classicConfigurations[17] = LibClub250Storage.ClassicConfig(153, 152, 39451500, 11 * 1e17, 1400, 0, 17, 39451500);
        es.classicConfigurations[18] = LibClub250Storage.ClassicConfig(171, 170, 64450000, 13 * 1e17, 2000, 0, 18, 64450000);
        es.classicConfigurations[19] = LibClub250Storage.ClassicConfig(190, 189, 114452500, 16 * 1e17, 2000, 0, 19, 114452500);
        es.classicConfigurations[20] = LibClub250Storage.ClassicConfig(210, 209, 214453000, 15 * 1e17, 2000, 0, 20, 214453000);
    }
